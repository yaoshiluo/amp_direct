...
class G1AmpEnv(DirectRLEnv):
    ...
    def _get_rewards(self) -> torch.Tensor:
        ...
        with torch.no_grad():
            ...
            amp_ref_motion = self.collect_reference_motions(self.num_envs, current_times).view(self.num_envs, self.cfg.num_amp_observations, -1)  # [N, T, D]
            amp_policy_motion = self.amp_observation_buffer[:, :self.cfg.num_amp_observations, :]  # [N, T, D]
